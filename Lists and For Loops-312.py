...
total_ratings = app_data_set[0][-1] + app_data_set[1][-1] + app_data_set[2][-1] + app_data_set[3][-1] + app_data_set[4][-1]
...
print(len(apps_data))
first_row = apps_data[0]
print(first_row)
second_and_third_row = apps_data[1:3]
